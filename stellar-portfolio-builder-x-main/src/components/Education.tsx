  ...
  const educationData: EducationItem[] = [
    {
      ...
      duration: "2024 - 2028",
      description: "Computer Science Student. Studying full stack development in First year.",
      achievements: []
    },
    {
      id: 2,
      ...
      duration: "2024 - 2027",
      description: "Currently pursuing Bachelor of Science in Computer Science. Achieved 7 CGPA/10 in 1st semester.",
      achievements: ["Dean's List - First Semester"]
    },
    {
      id: 3,
    ...
    <section id="education" className="vibrant-section">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <Badge className="mb-2 border-vibrant-red text-vibrant-orange font-medium">My Journey</Badge>
                    ...
                    {item.achievements.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {item.achievements.map((achievement, i) => (
                          <Badge key={i} className="bg-black/50 text-gray-200">{achievement}</Badge>
                        ))}
                      </div>
                    )}
                  </div>
